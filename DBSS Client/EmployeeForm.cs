...
namespace ServiceStation
{
	...
	public partial class EmployeeForm : Form
	{
		...
		/// <param name="e"></param>
		private void EmployeeFormLoader(object sender, EventArgs e)
		{
			...
			SourceList = new List<BindingSource>(4)
			{
			...
			List<MonthCalendar> mc = new List<MonthCalendar>(4)
			{
			...
			applicationOpenItem.PerformClick();
